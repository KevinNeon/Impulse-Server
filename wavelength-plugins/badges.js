...
exports.commands = {
	...
	badges: function (target, room, user) {
		...
		case 'set':
			...
			this.logModAction(user.name + " gave the badge '" + selectedBadge + "' badge to " + userid + ".");
		...
		case 'create':
			...
			this.logModAction(user.name + " created the badge '" + badgeName + ".");
		...
		case 'take':
			...
			userBadges = userBadges.filter(b => b !== selectedBadge);
			Db.userBadges.set(userid, userBadges);
			this.logModAction(user.name + " took the badge '" + selectedBadge + "' badge from " + userid + ".");
		...
		case 'delete':
			...
			this.logModAction(user.name + " removed the badge '" + selectedBadge + ".");
			break;
		case 'user':
